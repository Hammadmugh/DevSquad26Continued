            ...
            <div className="flex-1">
              <form onSubmit={isFullyCoveredByPoints ? (e) => { e.preventDefault(); handleFreeCheckout(); } : handleStripeCheckout} className="flex flex-col gap-6">
                ...
                <div className="border border-black/10 rounded-[20px] p-6 flex flex-col gap-5">
                  ...
                  <div className="flex flex-col gap-4">
                    ...
                    <div className="flex flex-col gap-1.5">
                      ...
                      <input type="text" placeholder="Landmark, area…" value={address.addressLine2} onChange={(e) => setAddress((a) => ({ ...a, addressLine2: e.target.value }))} className="w-full border border-black/20 rounded-xl px-4 py-3 text-base text-black focus:outline-none focus:border-black transition-colors" />
                    </div>
                    <div className="flex gap-4">
                      <div className="flex flex-col gap-1.5 flex-1">
                  ...
                  {isFullyCoveredByPoints ? (
                    <div className="flex items-center gap-3 bg-[#EFF6FF] border border-[#BFDBFE] rounded-[14px] px-4 py-4">
                      ...
                      <div>
                        ...
                        <p className="text-[12px] text-[#3B82F6]">Your points cover the full amount — no card needed.</p>
                      </div>
                    </div>
                  ) : (
                    <div className="flex flex-col gap-3">
                      ...
                      <div className="flex items-center gap-2 px-3 py-2 bg-black/5 rounded-[10px]">
                        ...
                        <p className="text-xs text-black/40">Test card: 4242 4242 4242 4242 · any future date · any CVV</p>
                      </div>
                    </div>
                  )}
                ...
                >
                  <LockIcon />
                  {paying
                    ? (isFullyCoveredByPoints ? "Placing Order…" : "Redirecting to Stripe…")
                    : isFullyCoveredByPoints
                      ? "Place Order (Free)"
